...
{
    public class CreateGuestEmergencyIntakeCommandValidator : AbstractValidator<CreateGuestEmergencyIntakeCommand>
    {
        private static readonly string[] ValidPetSpecies = { "Dog", "Cat" };
        private static readonly string[] ValidPetGenders = { "Male", "Female", "Unknown" };

        public CreateGuestEmergencyIntakeCommandValidator()
        {
