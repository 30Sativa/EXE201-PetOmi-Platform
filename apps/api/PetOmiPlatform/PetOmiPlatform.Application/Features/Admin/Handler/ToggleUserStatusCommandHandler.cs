...
public class ToggleUserStatusCommandHandler : IRequestHandler<ToggleUserStatusCommand, AdminUserListResponse>
{
    ...
    public async Task<AdminUserListResponse> Handle(ToggleUserStatusCommand request, CancellationToken cancellationToken)
    {
