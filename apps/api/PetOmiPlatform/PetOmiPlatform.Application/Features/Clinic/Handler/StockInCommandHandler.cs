...
{
    public class StockInCommandHandler : IRequestHandler<StockInCommand, InventoryItemResponse>
    {
        ...
        public async Task<InventoryItemResponse> Handle(
            StockInCommand command, CancellationToken cancellationToken)
        {
            ...
            item.StockIn(command.Request.Amount);
