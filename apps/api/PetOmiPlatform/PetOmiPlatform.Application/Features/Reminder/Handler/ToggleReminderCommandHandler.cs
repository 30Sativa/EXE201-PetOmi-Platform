...
{
    public class ToggleReminderCommandHandler : IRequestHandler<ToggleReminderCommand, ReminderResponse>
    {
        ...
        public async Task<ReminderResponse> Handle(ToggleReminderCommand command, CancellationToken ct)
        {
